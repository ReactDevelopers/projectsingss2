...
@section('content')
    {!! Form::open(['route' => ['admin.credit.credit.update', $credit->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('credit::admin.credits.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
