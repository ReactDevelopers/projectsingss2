...
@section('content-header')
    <h1>
        {{ trans('package::packages.title.packages') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('package::packages.title.packages') }}</li>
    </ol>
@stop
@section('styles')
        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.package.package.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                        <i class="fa fa-pencil"></i> {{ trans('package::packages.button.create package') }}
                    </a>
                </div>
            </div>
            --}}
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                     ...
                     <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th>
                                <a class="header-table" href="{{ get_url_query($current_url, $query_url, ['order_field' => 'price', 'sort' => $order_field == "price" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]) }}" >
                                    {{ trans('core::core.table.price') }}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.package.package.edit', [$item->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
                                    {{-- 
                                    <button class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.package.package.destroy', [$item->id]) }}"><i class="fa fa-trash"></i></button  
                                    --}}
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <th>{{ trans('core::core.table.price') }}</th>
                            <th data-sortable="false">{{ trans('core::core.table.actions') }}</th>
                        </tr>
                        </tfoot>
                    </table>
                    <div class="row">
                        ...
                        <div class="col-sm-7" style="text-align: right">
                            {!! $packages->appends(['limit' => $limit, 'keyword' => $keyword, 'page' => $page])->render() !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
                    <!-- /.box-body -->
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            $(document).keypressAction({
                actions: [
                    { key: 'c', route: "<?= route('admin.package.package.create') ?>" }
                ]
            });
        });
    </script>
