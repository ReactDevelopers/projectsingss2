    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="row">
                ...
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.customer.customer.exportcsv') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                ...
                <div class="box-body">
                    ...
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th>
                                <a class="header-table" href="{{ get_url_query($current_url, $query_url, ['order_field' => 'first_name', 'sort' => $order_field == "first_name" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]) }}" >
                        ...
                        <tr>
                            <td>{{ $item->id }}</td>
                            <td>{{ $item->first_name ? $item->first_name . ' ' . $item->last_name : $item->name }}</td>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.customer.customer.edit', [$item->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
                                    <button type="button" class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.customer.customer.destroy', [$item->id]) }}"><i class="fa fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7" style="text-align: right">
                            {!! $customers->appends(['limit' => $limit, 'keyword' => $keyword, 'page' => $page])->render() !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
