...
<div class="row">
    <div class="col-xs-12">
        <div class="row">
            ...
            <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                <a href="{{ route('admin.user.user.exportcsv') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
            ...
            <div class="box-body">
                ...
                <table class="data-table table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <a class="header-table" href="{{ get_url_query($current_url, $query_url, ['order_field' => 'last_name', 'sort' => $order_field == "last_name" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]) }}" >
                    ...
                    <?php if (isset($users)): ?>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    {{ $user->created_at && $user->created_at != \Carbon\Carbon::create(0, 0, 0, 0) ? \Carbon\Carbon::parse($user->created_at)->format('d/m/Y H:i:s') : "" }}
                                </td>
                                <td>
                                    {{ $user->last_login && $user->last_login != \Carbon\Carbon::create(0, 0, 0, 0) ? \Carbon\Carbon::parse($user->last_login)->format('d/m/Y H:i:s') : "" }}
                                </td>
                                <td>
                                    <div class="btn-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" style="text-align: right">
                        {!! $users->appends(['limit' => $limit, 'keyword' => $keyword, 'page' => $page])->render() !!}
                    </div>
                </div>
                {!! Form::close() !!}
            <!-- /.box-body -->
