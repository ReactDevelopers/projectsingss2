...
@section('content-header')
    <h1>
        {{ trans('advertisement::advertisements.title.create advertisement') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('advertisement::advertisements.title.create advertisement') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.advertisement.advertisement.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('advertisement::admin.advertisements.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
