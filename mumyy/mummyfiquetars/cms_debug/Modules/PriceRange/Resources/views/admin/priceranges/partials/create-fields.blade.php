<div class="box-body">
    <div class='form-group{{ $errors->has("price_name") ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text("price_name", Input::old('name'), ['class' => "form-control", 'placeholder' => trans('pricerange::priceranges.form.name')] ) !!}
	...
	<div class='form-group{{ $errors->has("description") ? ' has-error' : '' }}'>
	    ...
	    {!! Form::textarea("description", Input::old('description'), ['class' => "form-control", 'rows' => 5, 'placeholder' => trans('pricerange::priceranges.form.description')]) !!}
	    {!! $errors->first("description", '<span class="help-block">:message</span>') !!}
	</div>
<!-- 	<div class='form-group{{ $errors->has("sorts") ? ' has-error' : '' }}'>
	    {!! Form::label("sorts", trans('pricerange::priceranges.form.sort')) !!}
	    {!! Form::text("sorts", Input::old('sorts'), ['class' => "form-control", 'placeholder' => trans('pricerange::priceranges.form.sort')]) !!}
	    {!! $errors->first("sorts", '<span class="help-block">:message</span>') !!}
	</div> -->
	<div class='form-group{{ $errors->has("status") ? ' has-error' : '' }}'>
	    {!! Form::label("status", trans('pricerange::priceranges.form.status')) !!}
	    {!! Form::select("status", Config('constant.status'), old("status"), ['class' => "form-control"]) !!}
