...
@section('content')
    {!! Form::open(['route' => ['admin.audittrail.log.store'], 'method' => 'post' , 'name'=>'createlog', 'id' => 'admin-audittrail-log-create']) !!}
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    @include('audittrail::admin.logs.partials.create-fields')
