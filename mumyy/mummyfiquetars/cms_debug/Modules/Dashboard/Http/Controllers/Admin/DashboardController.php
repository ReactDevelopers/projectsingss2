...
class DashboardController extends AdminBaseController
{
    ...
    /**
     * @var PortfolioRequestRepository
     */
    private $portfolioRequestRepository;
     ...
     */
    public function __construct(Repository $modules, WidgetRepository $widget, Authentication $auth, CategoryRequestService $categoryRequestService, PortfolioRequestRepository $portfolioRequestRepository)
    {
        parent::__construct();
        ...
        $this->portfolioRequestRepository = $portfolioRequestRepository;
    }
    ...
    public function index()
    {
        ...
        $countVendorCategoryRequest = $this->categoryRequestService->count();
        $countPortfolioRequest = $this->portfolioRequestRepository->countAllRequest();

        return view('dashboard::admin.dashboard', compact(['customWidgets', 'countVendorCategoryRequest', 'countPortfolioRequest']));
    }
