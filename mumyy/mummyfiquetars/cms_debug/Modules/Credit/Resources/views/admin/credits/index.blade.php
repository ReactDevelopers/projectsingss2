...
@section('content-header')
    <h1>
        {{ trans('credit::credits.title.credits') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('credit::credits.title.credits') }}</li>
    </ol>
@stop
@section('styles')
        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.credit.credit.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                        <i class="fa fa-pencil"></i> {{ trans('credit::credits.button.create credit') }}
                    </a>
                </div>
            </div>
                ...
                <div class="box-body">
                    ...
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.credit.credit.show', [$credit->vendor_id]) }}" class="btn btn-default btn-flat"><i class="fa fa-eye"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7" style="text-align: right">
                            {!! $credits->appends(['limit' => $limit, 'keyword' => $keyword, 'page' => $page])->render() !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
                    <!-- /.box-body -->
...
@section('shortcuts')
    <dl class="dl-horizontal">
        <dt><code>c</code></dt>
        <dd>{{ trans('credit::credits.title.create credit') }}</dd>
    </dl>
@stop
