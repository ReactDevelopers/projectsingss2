...
<div class="box-body">
	<div class='form-group{{ $errors->has("title") ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text('title', Input::old('title', $advertisement->title), ['class' => 'form-control', 'placeholder' => trans('advertisement::advertisements.form.title')]) !!}
	    {!! $errors->first("title", '<span class="help-block">:message</span>') !!}
	</div>
	<div class='form-group{{ $errors->has("description") ? ' has-error' : '' }}'>
	    {!! Form::label("description", trans('advertisement::advertisements.form.description')) !!}
	    {!! Form::textarea('description', Input::old('description', $advertisement->description), ['class' => 'form-control', 'rows' => '3', 'placeholder' => trans('advertisement::advertisements.form.description')]) !!}
	    {!! $errors->first("description", '<span class="help-block">:message</span>') !!}
	</div>{{$advertisement->id}}
	<div class="form-group{{ $errors->has("medias_single") ? ' has-error' : '' }}">
	 ...
	 <div class='form-group{{ $errors->has("adv_id") ? ' has-error' : '' }}'>
	    ...
	    {!! Form::select("adv_id", $types, old("adv_id", $advertisement->adv_id), ['class' => "form-control"]) !!}
	...
	<div class='form-group{{ $errors->has("link") ? ' has-error' : '' }}'  id="adv-link">
	    ...
	    {!! Form::text('link', Input::old('link', $advertisement->link), ['class' => 'form-control', 'placeholder' => trans('advertisement::advertisements.form.link')]) !!}
	...
	<div class='form-group{{ $errors->has("by") ? ' has-error' : '' }}'  id="adv-by">
	    ...
	    {!! Form::text('by', Input::old('by', $advertisement->by), ['class' => 'form-control', 'placeholder' => trans('advertisement::advertisements.form.by')]) !!}
	...
	{{--
 	<div class='form-group{{ $errors->has("sorts") ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text('sorts', Input::old('sorts', $advertisement->sorts), ['class' => 'form-control', 'placeholder' => trans('advertisement::advertisements.form.sort')]) !!}
	...
	<div class='form-group{{ $errors->has("status") ? ' has-error' : '' }}'>
	    ...
	    {!! Form::select("status", Config('asgard.advertisement.config.status'), old("adv_id", $advertisement->status), ['class' => "form-control"]) !!}
	    {!! Form::hidden('id', Input::old('id', $advertisement->id), ['class' => 'form-control']) !!}
