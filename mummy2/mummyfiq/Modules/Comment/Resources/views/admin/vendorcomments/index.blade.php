...
@section('content-header')
    <h1>
        {{ trans('comment::comments.title.vendor comments') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('comment::comments.title.vendor comments') }}</li>
    </ol>
@stop
@section('styles')
        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.comment.vendorcomment.getExportVendorComment') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                ...
                <div class="box-body">
                    ...
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th>
                                <a class="header-table" href="{{ get_url_query($current_url, $query_url, ['order_field' => 'portfolio_title', 'sort' => $order_field == "portfolio_title" ? ($sort == "DESC" ? "ASC" : "DESC") : "DESC"]) }}" >
                                    Portfolio
                                    @if($order_field == 'portfolio_title')
                                        @if($sort == 'DESC')
                                            <span class="fa fa-sort-amount-desc span-header-table"></span>
                                        @else
                                            <span class="fa fa-sort-amount-asc span-header-table"></span>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.comment.vendorcomment.edit', [$comment->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
                                    <button type="button" class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.comment.vendorcomment.destroy', [$comment->id]) }}"><i class="fa fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
