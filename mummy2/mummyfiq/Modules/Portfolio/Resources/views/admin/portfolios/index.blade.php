    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="row">
                ...
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.portfolio.portfolio.exportcsv') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            <td>{{ $portfolio->id }}</td>
                            <td>{{ $portfolio->vendor->getVendorBusinessName() }}</td>
                            <td>{{ $portfolio->title }}</td>
                            <td>{{ $portfolio->category ? $portfolio->category->name : "" }}</td>
                            <td>{{ $portfolio->city }}</td>
                            <td>{{ str_limit($portfolio->description, 50) }}</td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.portfolio.portfolio.destroy', [$portfolio->id]) }}"><i class="fa fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
