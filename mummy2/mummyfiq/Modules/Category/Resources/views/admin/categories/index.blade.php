                ...
                <div class="box-body">
                    ...
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            <td>{{ $item->id }}</td>
                            <td>{{ $item->name }}</td>
                            <td>{{ Config('asgard.category.config.status')[$item->status] }}</td>
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.category.category.edit', [$item->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
                                    <button type="button" class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.category.category.destroy', [$item->id]) }}"><i class="fa fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7" style="text-align: right">
                            {!! $categories->appends(['limit' => $limit, 'keyword' => $keyword, 'page' => $page])->render() !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
