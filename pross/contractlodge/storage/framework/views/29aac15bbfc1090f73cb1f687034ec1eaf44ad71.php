    ...
    <div>
        <div>
            <div class="card card-default" v-if="tokens.length > 0">
                <div class="card-header"><?php echo e(__('API Tokens')); ?></div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <?php echo e(__('Edit Token')); ?> ({{ updatingToken.name }})
                        </h5>
                    </div>
        ...
        <div class="modal" id="modal-delete-token" tabindex="-1" role="dialog">
            <div class="modal-dialog" v-if="deletingToken">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <?php echo e(__('Delete Token')); ?> ({{ deletingToken.name }})
                        </h5>
                    </div>

                    <div class="modal-body">
                        <?php echo e(__('Are you sure you want to delete this token? If deleted, API requests that attempt to authenticate using this token will no longer be accepted.')); ?>

                    </div>

                    <!-- Modal Actions -->
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('No, Go Back')); ?></button>
