<spark-update-password inline-template>
    <div class="card card-default">
        <div class="card-header"><?php echo e(__('Update Password')); ?></div>

        <div class="card-body">
            <!-- Success Message -->
            <div class="alert alert-success" v-if="form.successful">
                <?php echo e(__('Your password has been updated!')); ?>
            ...
            <form role="form">
                ...
                <div class="form-group row">
                    <label class="col-md-4 col-form-label text-md-right"><?php echo e(__('Current Password')); ?></label>
