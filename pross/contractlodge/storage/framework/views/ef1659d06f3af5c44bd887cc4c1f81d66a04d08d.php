<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="alert alert-danger" v-if="invalidCoupon">
            <?php echo e(__('Whoops! This coupon code is invalid.')); ?>
        ...
        <div class="alert alert-danger" v-if="invalidInvitation">
            <?php echo e(__('Whoops! This invitation code is invalid.')); ?>
        ...
        <div class="card card-default">
            ...
            <div class="table-responsive">
                ...
                <?php if(Spark::collectsEuropeanVat()): ?>
                    <p class="m-4">
                        <?php echo e(__('All subscription plan prices are excluding applicable VAT.')); ?>
                        ...
                        <tr v-for="plan in plansForActiveInterval">
                            ...
                            <td>
                                <button class="btn btn-default" @click="showPlanDetails(plan)">
                                    <i class="fa fa-btn fa-star-o"></i> <?php echo e(__('Features')); ?>
    ...
    <div class="col-lg-8">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <!-- Registration Form -->
                <?php echo $__env->make('spark::auth.register-common-form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </div>
</div>
