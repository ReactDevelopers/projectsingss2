<form role="form">
    <?php if(Spark::usesTeams() && Spark::onlyTeamPlans()): ?>
        <!-- Team Name -->
        <div class="form-group row" v-if=" ! invitation">
            <label class="col-md-4 col-form-label text-md-right"><?php echo e(__('teams.team_name')); ?></label>
        ...
        <?php if(Spark::teamsIdentifiedByPath()): ?>
            <!-- Team Slug (Only Shown When Using Paths For Teams) -->
            <div class="form-group row" v-if=" ! invitation">
                <label class="col-md-4 col-form-label text-md-right"><?php echo e(__('teams.team_slug')); ?></label>
                ...
                <div class="col-md-6">
                    ...
                    <small class="form-text text-muted" v-show="! registerForm.errors.has('team_slug')">
                        <?php echo e(__('teams.slug_input_explanation')); ?>
    ...
    <div class="form-group row">
        <label class="col-md-4 col-form-label text-md-right"><?php echo e(__('Name')); ?></label>
    ...
    <div class="form-group row">
        <label class="col-md-4 col-form-label text-md-right"><?php echo e(__('Confirm Password')); ?></label>
