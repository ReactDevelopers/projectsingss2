            ...
            <div class="row">
              ...
              18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
                            ...
                            <?php if(Spark::usesTeams()): ?>
                                <li class="nav-item ">
                                    <a class="nav-link" href="#<?php echo e(Spark::teamsPrefix()); ?>" aria-controls="teams" role="tab" data-toggle="tab">
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                        ...
                        <div role="tabcard" class="tab-pane active" id="profile">
                            <?php echo $__env->make('spark::settings.profile', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>

                        <!-- Teams -->
                        <?php if(Spark::usesTeams()): ?>
                            <div role="tabcard" class="tab-pane" id="<?php echo e(Spark::teamsPrefix()); ?>">
                                <?php echo $__env->make('spark::settings.teams', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                        <?php endif; ?>

                    <!-- Security -->
                        <div role="tabcard" class="tab-pane" id="security">
                            <?php echo $__env->make('spark::settings.security', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>

                        <!-- API -->
                        <?php if(Spark::usesApi()): ?>
                            <div role="tabcard" class="tab-pane" id="api">
                                <?php echo $__env->make('spark::settings.api', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                        <?php endif; ?>
                    ...
                    <!-- Billing Tab Panes -->
                        <?php if(Spark::canBillCustomers()): ?>
                            ...
                            <!-- Subscription -->
                                <div role="tabcard" class="tab-pane" id="subscription">
                                    <div v-if="user">
                                        <?php echo $__env->make('spark::settings.subscription', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                        ...
                        <!-- Payment Method -->
                            <div role="tabcard" class="tab-pane" id="payment-method">
                                <div v-if="user">
                                    <?php echo $__env->make('spark::settings.payment-method', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                            </div>

                            <!-- Invoices -->
                            <div role="tabcard" class="tab-pane" id="invoices">
                                <?php echo $__env->make('spark::settings.invoices', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
