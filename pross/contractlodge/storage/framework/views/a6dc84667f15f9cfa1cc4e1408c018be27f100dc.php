        ...
        <div class="modal-content">
            <div class="modal-body p-b-none">
                <form role="form">
                    ...
                    <div class="form-group" :class="{'is-invalid': supportForm.errors.has('from')}">
                        <input id="support-from" type="text" class="form-control" v-model="supportForm.from" placeholder="<?php echo e(__('Your Email Address')); ?>">
                    ...
                    <div class="form-group" :class="{'is-invalid': supportForm.errors.has('subject')}">
                        <input id="support-subject" type="text" class="form-control" v-model="supportForm.subject" placeholder="<?php echo e(__('Subject')); ?>">
                    ...
                    <div class="form-group m-b-none" :class="{'is-invalid': supportForm.errors.has('message')}">
                        <textarea class="form-control" rows="7" v-model="supportForm.message" placeholder="<?php echo e(__('Message')); ?>"></textarea>
            ...
            <div class="modal-footer border-none">
                <button type="button" class="btn btn-primary" @click.prevent="sendSupportRequest" :disabled="supportForm.busy">
                    <i class="fa fa-btn fa-paper-plane"></i> <?php echo e(__('Send')); ?>
