<update-notification-options :user="user" inline-template>
    <div class="card card-default">
        <div class="card-header"><?php echo e(__('Notification Options')); ?></div>

        <div class="card-body">
            <div class="alert alert-success" v-if="form.successful">
                <?php echo e(__('Your notification option have been updated!')); ?>
            ...
            <form role="form">
                <div class="form-group row">
                    <label class="col-md-4 col-form-label text-md-right">
                        <?php echo e(__('Hotel Payment Schedule Emails')); ?>
