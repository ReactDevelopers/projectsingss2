...
@section('content')
    <div id="top" class="page" role="document">
        <header role="banner">
            <img src="https://contractlodge.com/images/f1-logo.png" alt="Formula 1" width="150px" style="float:left; margin-right: 10px;">
        ...
        <article id="text__paragraphs">
            <header><h1>Paragraphs</h1></header>
                <div>
                    ...
                    or more sentences. Though not required by the syntax of any language, paragraphs are usually an expected
