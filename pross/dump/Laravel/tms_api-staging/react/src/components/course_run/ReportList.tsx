...
import reportCols from './columns/ReportColumn';
...
class List extends React.Component <RunCourseListProps> {
    ...
    constructor(props: RunCourseListProps) {
        ...
        this.EndPoint = {...API.COURSE_RUN_REPORT_LIST}
    }  
    ...
    render() {
        ...
        const breadcrumbs = [
            {
                title: 'Course Run Data Report',
                url: '/course-run-report'
            }
        ];
        ...
        return (
            ...
            >      
                ...
                columns={reportCols(customFilters, this.props, this.refreshTable)} 
                exportFileName="course_run_report.xlsx"
