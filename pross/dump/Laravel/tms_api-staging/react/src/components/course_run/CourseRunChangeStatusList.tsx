...
import changeStatusCourseRunCols from './columns/ChangeStatusCourseRunColumn';
...
class List extends React.Component <RunCourseListProps> {
    ...
    constructor(props: RunCourseListProps) {
        ...
        this.EndPoint = {...API.COURSE_RUN_STATUS_LIST}
    }
    ...
    render() {
        ...
        const breadcrumbs = [
            {
                title: 'Edit Course Run Status',
                url: '/course-run-change-status'
            }
        ];
        ...
        const customFilters: {[key: string]: any} =  this.props.helper.deepFind(this.props.rootState, 'server.course_run_'+this.props.pageFor+'.requestData.customFilters');
        ...
        return (
            <Template {...this.props} 
                ...
                <Table {...this.props} 
                batchDeleteBtn={true}
                columns={changeStatusCourseRunCols(customFilters, this.props, this.refreshTable)} 
