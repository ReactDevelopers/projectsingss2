...
class SupervisorUploadTest extends TestCase
{
    ...
    public function test_upload_with_blank_request() {
        ...
        $response = $this->call('POST','user/upload', [],[],[], $this->getAuthHeader(true));
    ...
    public function test_upload_with_invalid_file() {
        ...
        $response = $this->call('POST','user/upload',[],[],['file'=> $file], $this->getAuthHeader());
        $this->assertResponseStatus(422);
