        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <?php 
                 ...
                 ?>
                    <div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12"><?php echo e(trans('website.W0369')); ?></label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="radio radio-inline">                
                                <input name="company_profile" type="radio"  value="individual" id="individual"  <?php echo e(($user['company_profile'] == 'individual') ? 'checked=""' : ''); ?>  class="company_type">
                                <label for="individual"><?php echo e(trans('website.W0545')); ?></label>
                            </div>
                            <div class="radio radio-inline">                
                                <input name="company_profile" type="radio"  value="company" <?php echo e(($user['company_profile'] == 'company') ? 'checked=""' : ''); ?> id="company" class="company_type">
                                <label for="company"><?php echo e(trans('website.W0943')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" id="company_info">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <input name="company_name" value="<?php echo e(!empty($companydata->company_name) ? @$companydata->company_name : ''); ?>" type="text" class="form-control" data-toggle="tooltip" title="" data-original-title="">
                        </div>
                        <label class="col-md-12 col-sm-12 col-xs-12 control-label">Company Website </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <input name="company_website" value="<?php echo e(!empty($companydata->company_website) ? @$companydata->company_website : ''); ?>" type="text" class="form-control" data-toggle="tooltip" title="" data-original-title="">
                        </div>
                        <label class="col-md-12 col-sm-12 col-xs-12 control-label">Tell us more about your company </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <textarea name="company_biography" class="form-control" placeholder="Enter description here"><?php echo e(!empty($companydata->company_biography) ? @$companydata->company_biography : ''); ?></textarea>
                        </div>
                        <label class="col-md-12 col-sm-12 col-xs-12 control-label">Company Logo</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <img src="<?php echo e(@$companydata->company_logo); ?>" height="150px" width="150px"> 
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <?php if($user['company_profile'] == 'company'): ?>
                    <div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12"><?php echo e(trans('website.W0995')); ?></label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="radio radio-inline">                
                                <input name="show_profile" type="radio" id="yes"  value="yes" <?php echo e(($user['show_profile'] == 'yes') ? 'checked=""' : ''); ?>  class="company_type">
                                <label for="yes"><?php echo e(trans('website.W0976')); ?></label>
                            </div>
                            <div class="radio radio-inline">                
                                <input name="show_profile" type="radio" id="no"  value="no" <?php echo e(($user['show_profile'] == 'no') ? 'checked=""' : ''); ?>  class="company_type">
                                <label for="no"><?php echo e(trans('website.W0102')); ?></label>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
