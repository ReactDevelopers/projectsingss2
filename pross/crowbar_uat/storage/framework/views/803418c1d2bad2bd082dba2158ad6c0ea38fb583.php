            ...
            <div class="afterlogin-section viewProfile">
                <div class="container">
                    <div class="row mainContentWrapper">
                        <?php if ($__env->exists('employer.viewprofile.includes.sidebar')) echo $__env->make('employer.viewprofile.includes.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <div class="col-md-8 col-sm-8 col-xs-12 no-padding-xs">
                            <?php if ($__env->exists('employer.settings.includes.header',$user)) echo $__env->make('employer.settings.includes.header',$user, array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
