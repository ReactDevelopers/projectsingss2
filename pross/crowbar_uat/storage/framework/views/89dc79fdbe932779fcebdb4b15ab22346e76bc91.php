            ...
            <div class="afterlogin-section viewProfile">
                <div class="container">
                    <div class="row mainContentWrapper">
                        <?php if($view !== 'talent.jobdetail.disputes'): ?>
                            <?php if ($__env->exists('talent.jobdetail.includes.sidebar')) echo $__env->make('talent.jobdetail.includes.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php else: ?>
                            <?php if ($__env->exists('talent.jobdetail.includes.disputes')) echo $__env->make('talent.jobdetail.includes.disputes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php endif; ?>
