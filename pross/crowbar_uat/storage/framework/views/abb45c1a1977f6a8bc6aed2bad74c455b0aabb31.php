...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('css/easy-responsive-tabs.css')); ?>" rel="stylesheet" media="all" type="text/css" />
        ...
        <?php echo $__env->yieldContent('toprequirejs'); ?>
    ...
    <body>
        <div class="wrapper">
            <?php echo $__env->make(sprintf('%s.includes.%s',TALENT_ROLE_TYPE,$header), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <script type="text/javascript">
            $(document).on('click','[data-request="home-follow-user"]',function(){
                $('#popup').show(); 
                var $this = $(this);
                ...
                $.ajax({
                    ...
                    success: function($response){
                        $('#popup').hide();
                        if($('[data-request="home-follow-user"]').hasClass('active')){
                            $('[data-user_id="'+$response.user_id+'"]').removeClass('active');
                            $('[data-user_id="'+$response.user_id+'"]').html($response.data);
                        }else {
                            $('[data-user_id="'+$response.user_id+'"]').addClass('active');
                            $('[data-user_id="'+$response.user_id+'"]').html($response.data);
                        }
