                    ...
                    <div class="nav-tabs-custom no-margin">
                        ...
                        <div class="tab-content no-padding">
                            ...
                            <div class="tab-pane <?php echo ($page == 'firm_detail')?'active':''; ?>">
                                <?php if($page == 'firm_detail'): ?>
                                <?php echo $__env->make('backend.talent.firm_detail', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php endif; ?>
                            </div>
                            <div class="tab-pane <?php echo ($page == 'connected_talent')?'active':''; ?>">
                                <?php if($page == 'connected_talent'): ?>
                                <?php echo $__env->make('backend.talent.connected_talent', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
