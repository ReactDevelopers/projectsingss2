                ...
                <div class="container">
                    <div class="row mainContentWrapper">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12 no-padding-xs">
                            <?php if ($__env->exists('talent.settings.includes.header',$user)) echo $__env->make('talent.settings.includes.header',$user, array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
