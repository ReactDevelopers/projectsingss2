    ...
    <div class="user-info-wrapper user-info-greyBox viewProfileBox clearfix">
        ...
        <?php 
            ...
            if(!empty($user['first_name']) && !empty($user['id_user'])){
                $shareUrl = url('/showprofile/'.strtolower($user['first_name']).'-'.strtolower($user['last_name']).'/'.___encrypt($user['id_user']));
            } 
         ?>
        <?php if(!empty($shareUrl)): ?>
            ...
            <div class="talent-share-profile clearfix">
                ...
                <ul>
                    ...
                    <li>
                        <a href="https://web.whatsapp.com/send?text=<?php echo e($shareUrl); ?>" target="_blank" id="whatsapp_link" data-action="share/whatsapp/share" ><img src="<?php echo e(asset('images/whatsapp-logo.png')); ?>"></a>
                    </li>
                </ul>
            </div>
        <?php endif; ?>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        if(isMobile1 == 'Mobile'){
            ...
            $('#whatsapp_link').attr('href','https://web.whatsapp.com/send<?php echo e($shareUrl); ?>');
        }
    });
</script>
<?php $__env->stopPush(); ?>