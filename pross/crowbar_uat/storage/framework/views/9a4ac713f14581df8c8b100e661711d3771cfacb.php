...
<form class="form-horizontal" role="post_event" action="<?php echo e(url('/talent/post-event/process')); ?>" method="post" accept-charset="utf-8" id="post_event">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div>
									<select name="event_type" id="event_type" style="max-width: 400px; width: 100%;" class="form-control select2-hidden-accessible">
										...
										<option value="live" data-condition="live"><?php echo e(trans('website.W0852')); ?></option>
										<option value="virtual" data-condition="virtual"><?php echo e(trans('website.W0853')); ?></option>
									</select>
								</div>
							</div>
						</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="single-remove">
                                    <div class="fileUpload upload-docx"><span><?php echo e(trans('website.W0865')); ?></span>
                                        <input type="file" name="file" id="file" class="upload" data-request="inline-doc-submit" data-target="#appenddochere" action="<?php echo e(url(sprintf('%s/doc-submit',TALENT_ROLE_TYPE))); ?>">
                                    </div>
							...
							<div class="event-availability">
								<div>
									<select name="user_type" style="max-width: 400px; width: 100%;" class="form-control select2-hidden-accessible">
										<option value="individual">Post as <?php echo e(\Auth::user()->name); ?></option>
			...
			<div class="row form-btn-set">
				<div class="col-md-7 col-sm-7 col-xs-6">
					<button type="button" name="later_button" id="later_button" class="greybutton-line">
						<?php echo e(trans('website.W0872')); ?>
...
<?php else: ?>
<form class="form-horizontal" role="post_event" action="<?php echo e(url('/talent/post-event/process')); ?>" method="post" accept-charset="utf-8">
	<?php echo e(csrf_field()); ?>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-6">
						...
						<div class="datebox-no startdate">
							<label class="control-label"><?php echo e(trans('website.W0368')); ?></label>  
							<div class="input-group datepicker">
								<input type="text" id="event_date" name="event_date" class="form-control" placeholder="DD/MM/YYYY" value="<?php echo e($event_date); ?>" maxlength="10">
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-6">
...
<?php if(!empty($event_list)): ?>
	<?php $__currentLoopData = $event_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
		<?php echo view('talent.community.event-template')->with($value)->render(); ?>
...
<?php $__env->startPush('inlinescript'); ?>
	...
	<script type="text/javascript">
		...
		$('#later_button').on('click',function(){
			var url = $('#post_event').attr('action', "<?php echo e(url('/talent/post-event/process/draft')); ?>");
