    ...
    <?php $__currentLoopData = $work_experience_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
        <div class="col-md-6 col-sm-12 col-xs-12 experience-white-box" id="experience-<?php echo e($item['id_experience']); ?>">
            <div class="educationEditSec">
                ...
                <div class="addIcons">
                    <a href="javascript:void(0);" class="edit-icon" title="Edit" data-url="<?php echo e(sprintf(url('ajax/%s?id_experience=%s'), EDIT_TALENT_EXPERIENCE, $item['id_experience'] )); ?>" data-request="edit" data-experience_id="<?php echo e($item['id_experience']); ?>" data-edit-id="experience_id">
                        <img src="<?php echo e(asset('/images/edit-icon.png')); ?>">
                    </a>
                    <a href="javascript:void(0);" data-edit-id="experience_id" title="Delete" data-url="<?php echo e(sprintf(url('ajax/%s?id_experience=%s'), DELETE_TALENT_EXPERIENCE, $item['id_experience'] )); ?>" data-request="delete" data-experience_id="<?php echo e($item['id_experience']); ?>" data-delete-id="experience_id" data-toremove="experience" data-ask="Do you realy want to delete your experience?">
