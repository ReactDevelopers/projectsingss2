    ...
    @section('content')
        ...
        <div class="contentWrapper">
            <div class="afterlogin-section viewProfile">
                ...
                <button type="button" id="btn-select-type" class="button-line" data-target="#add-select-type" data-request="ajax-modal" data-url="{{url('talent/accept-reject-transfer-modal/'.$user_id)}}" style="display: none;"></button>
            </div>
        </div>
    @endsection
