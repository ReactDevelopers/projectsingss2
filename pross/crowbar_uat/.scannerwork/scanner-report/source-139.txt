            ...
            <div class="afterlogin-section viewProfile">
                <div class="container">
                    <div class="row mainContentWrapper">
                        <?php if ($__env->exists('talent.myjob.includes.sidebar')) echo $__env->make('talent.myjob.includes.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
