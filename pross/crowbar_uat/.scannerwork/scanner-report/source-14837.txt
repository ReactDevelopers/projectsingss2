                ...
                <div class="row mainContentWrapper">
                    ...
                    <div class="col-md-3 left-sidebar bottom-margin-10px" id="left-sidebar">
                        <div class="sidebar-content">
                            <h3>Filters <span data-request="clear-filter" data-url="{{ url(sprintf('%s/hire-premium-talents',EMPLOYER_ROLE_TYPE)) }}" id="clearAll">Clear All</span></h3>
                            <div class="filter-options">
                                ...
                                <div class="price-range-slider">
                                    ...
                                    <div class="nstSlider" data-range_min="{{ (range_filter($currency)['permanent_salary_range']['minimum']) }}" data-range_max="{{ (range_filter($currency)['permanent_salary_range']['maximum']) }}" data-cur_min="{{ (range_filter($currency)['permanent_salary_range']['minimum']) }}"  data-cur_max="{{ (range_filter($currency)['permanent_salary_range']['maximum']) }}">
                                        <div class="bar"></div>
                                ...
                                <div class="location-filter">
                                    <input type="text" name="location_filter" placeholder="{{ trans('general.M0195') }}" class="form-control" data-request="city-filter" data-url="{{ url('ajax/user-state-list') }}" data-target=".city-filter-group" data-action="filter">
                    ...
                    <div class="col-md-9 right-sidebar">
                        <h2 class="sidebar-heading form-heading">
                        ...
                        <div>
                           <div id="loadmore">
                               <button type="button" class="btn btn-default btn-block btn-lg" data-request="filter-paginate" data-url="{{ url(sprintf('%s/_hire-premium-talents',EMPLOYER_ROLE_TYPE)) }}" data-target="#talent_listing" data-showing="#paginate_showing" data-loadmore="#loadmore" data-form="[role='find-talents']">{{ trans('website.W0254') }}</button>
                           </div>
                       </div>
...
@endsection
@push('inlinescript')
    <link rel="stylesheet" href="{{ url('asset/jquery.mCustomScrollbar.min.css') }}" media="all" type="text/css" />
