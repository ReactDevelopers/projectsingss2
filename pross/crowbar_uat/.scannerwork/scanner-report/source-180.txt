...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            <?php echo $__env->make(sprintf('%s.includes.%s',EMPLOYER_ROLE_TYPE,$header), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <script src="<?php echo e(asset('/script/employer.js')); ?>"></script>
    </body>
