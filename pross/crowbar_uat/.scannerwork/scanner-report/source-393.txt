            ...
            <div class="row mainContentWrapper">
                ...
                <div class="col-md-3 left-sidebar bottom-margin-10px" id="left-sidebar">
                    <div class="sidebar-content">
                        <h3>Filters <span data-request="clear-filter" data-url="<?php echo e(url(sprintf('%s/find-jobs',TALENT_ROLE_TYPE))); ?>" id="clearAll">Clear All</span></h3>
                        <div class="filter-options">
                            <h4><?php echo e(trans('website.W0342')); ?></h4>
                            <div class="filter-list-group">
                                <input type="text" value="<?php echo e(\Request::get('_search')); ?>" name="search" placeholder="Search" class="form-control" id="search_job" data-request="search"/>
                            </div>
                            ...
                            <ul class="filter-list-group">
                                <?php $__currentLoopData = employment_types('web_post_job'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <li>
                                        <div class="checkbox ">                
                                            <input type="checkbox" id="employement-<?php echo e($value['type']); ?>" name="employment_type_filter" value="<?php echo e($value['type']); ?>"  data-action="filter" <?php if(in_array($value['type'],$user['interested']) && 0): ?> checked="checked" <?php endif; ?>>
                ...
                <div class="col-md-9 right-sidebar">
                    <h2 class="form-heading">
                        ...
                        <div class="heading-filter small-select">
                            ...
                            <div class="custom-dropdown sortby-filter sortby-arrow-filter">
                    ...
                    <div>
                       <div id="loadmore">
                           <button type="button" class="btn btn-default btn-block btn-lg hide" data-request="filter-paginate" data-url="<?php echo e(url(sprintf('%s/_find-jobs',TALENT_ROLE_TYPE))); ?>" data-target="#job_listing" data-showing="#paginate_showing" data-loadmore="#loadmore" data-form="[role='find-jobs']"><?php echo e(trans('website.W0254')); ?></button>
                       </div>
                   </div>
...
<?php $__env->startPush('inlinescript'); ?>
    ...
    <script>
        $( function() {
            ...
            $('input[name="employment_type_filter"]').on('change', function() {
                $('input[name="employment_type_filter"]').not(this).prop('checked', false);
            });

            $("#search_job").bind('keypress', function(e) {    
                var k = e.which;
            ...
            $("input[name='price_min_filter'],input[name='price_max_filter']").bind('keypress', function(e) {    
                var k = e.which; 
