...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('css/placeholder.min.css')); ?>" rel="stylesheet" />
    ...
    <body>
        <div class="wrapper">
            <?php echo $__env->make(sprintf('%s.includes.%s',(\Auth::user()->type),$header), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <script type="text/javascript">
            var user_id     = "<?php echo e(Auth::user()->id_user); ?>";
            $(function () {
                $.ajaxSetup({
                    headers: {
