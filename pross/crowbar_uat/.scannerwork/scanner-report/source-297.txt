    ...
    <?php $__env->startSection('content'); ?>
        ...
        <div class="contentWrapper">
            <div class="afterlogin-section viewProfile">
                ...
                <button type="button" id="btn-select-type" class="button-line" data-target="#add-select-type" data-request="ajax-modal" data-url="<?php echo e(url('select-profile-modal')); ?>" style="display: none;"></button>
            </div>
        </div>
    <?php $__env->stopSection(); ?>
