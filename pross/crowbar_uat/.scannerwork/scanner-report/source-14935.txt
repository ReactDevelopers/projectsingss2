...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('css/easy-responsive-tabs.css')}}" rel="stylesheet" media="all" type="text/css" />
    ...
    <body>
        <div class="wrapper">
            @include(sprintf('%s.includes.%s',TALENT_ROLE_TYPE,$header))
            @yield('content')
            @include('footer')
            {{-- @include(sprintf('%s.includes.%s',TALENT_ROLE_TYPE,$footer)) --}}
        </div>
