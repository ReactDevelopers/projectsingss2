<form class="form-horizontal" role="employer_step_one" action="<?php echo e(url(sprintf('%s/hire/talent/process/one',EMPLOYER_ROLE_TYPE))); ?>" method="post" accept-charset="utf-8">
	<?php echo e(csrf_field()); ?>

	<div class="login-inner-wrapper">
		<h2 class="form-heading no-padding"><?php echo e(trans('website.W0652')); ?></h2>
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="form-group">
					<label class="control-label col-md-12"><?php echo e(trans('website.W0285')); ?></label>
					<div class="col-md-12">
						<div class="custom-dropdown">
							<input type="text" name="title" class="form-control" placeholder="<?php echo e(trans('website.W0654')); ?>" value="<?php echo e($project['title']); ?>">
							<input type="text" class="hide" name="id_project" value="<?php echo e($project['id_project']); ?>">
				...
				<div class="form-group">
					<label class="control-label col-md-12 col-sm-12 col-xs-12"><?php echo e(trans('website.W0284')); ?></label>
					<div class="col-md-12 col-sm-12 col-xs-12">
						<textarea id="description" name="description" placeholder="<?php echo e(trans('website.W0653')); ?>" class="form-control"><?php echo e($project['description']); ?></textarea>
					</div>
				</div>
				<div class="form-group">
...
<?php $__env->startPush('inlinescript'); ?>
	...
	<script type="text/javascript">
	    ...
	    $.ajax({
            type : 'GET',
            url : '<?php echo e(url("employer/check-job/payment-configure")); ?>',
