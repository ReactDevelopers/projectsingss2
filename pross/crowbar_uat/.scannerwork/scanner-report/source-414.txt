    ...
    <div class="postjob-beforesubmit">
        <div class="container">
            <div class="right-sidebar payment-detail-sec no-padding-left no-padding-bottom">
                <h2 class="no-margin-bottom"><?php echo e(trans('website.W0375')); ?></h2>
                <ul class="payment-blocks clearfix">
                    <li> <a href="javascript:void(0);" class="total-amount-block"> <span class="payment-text"> <h3><?php echo e(trans('website.W0376')); ?></h3> <span><?php echo e($payment_summary['total_received']); ?></span> </span> </a> </li>
                    <li> <a href="javascript:void(0);" class="total-amount-due-block"> <span class="payment-text"> <h3><?php echo e(trans('website.W0377')); ?></h3> <span><?php echo e($payment_summary['total_due']); ?></span> </span> </a> </li>
                    <li> <a href="javascript:void(0);" class="total-job-posted-block"> <span class="payment-text"> <h3><?php echo e(trans('website.W0729')); ?></h3> <span><?php echo e($payment_summary['total_completed_job']); ?></span> </span> </a> </li>
                </ul>
                <div class="row">
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <div id="parentHorizontalTab">
                            <?php echo ___getmenu('talent-wallet','%s<ul class="payment-tabs-wrapper">%s</ul>','active-tab',true,false); ?>
