			...
			<div class="afterlogin-section viewProfile">
				<div class="container">
                    <div class="row mainContentWrapper">
						<?php if ($__env->exists('talent.profile.includes.sidebar')) echo $__env->make('talent.profile.includes.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
							...
							<div class="navigation-bar">
								<ul>
									<li class="<?php if(in_array('one',$steps)): ?> <?php echo e('selected'); ?> <?php endif; ?>">
										...
										<a href="<?php echo e(url(sprintf('%s/profile/%sstep/one',TALENT_ROLE_TYPE,$edit_url))); ?>" class="navigation-dot"></a>
									</li>
									<li class="<?php if(in_array('two',$steps)): ?> <?php echo e('selected'); ?> <?php endif; ?>">
										<span class="navigation-stepCount">2</span>
										<a href="<?php echo e(url(sprintf('%s/profile/%sstep/two',TALENT_ROLE_TYPE,$edit_url))); ?>" class="navigation-dot"></a>
									</li>
									<li class="<?php if(in_array('three',$steps)): ?> <?php echo e('selected'); ?> <?php endif; ?>">
										<span class="navigation-stepCount">3</span>
										<a href="<?php echo e(url(sprintf('%s/profile/%sstep/three',TALENT_ROLE_TYPE,$edit_url))); ?>" class="navigation-dot"></a>
									</li>
									<li class="<?php if(in_array('four',$steps)): ?> <?php echo e('selected'); ?> <?php endif; ?>">
										<span class="navigation-stepCount">4</span>
										<a href="<?php echo e(url(sprintf('%s/profile/%sstep/four',TALENT_ROLE_TYPE,$edit_url))); ?>" class="navigation-dot"></a>
									</li>
									<li class="<?php if(in_array('five',$steps)): ?> <?php echo e('selected'); ?> <?php endif; ?>">
										<span class="navigation-stepCount">5</span>
										<a href="<?php echo e(url(sprintf('%s/profile/%sstep/five',TALENT_ROLE_TYPE,$edit_url))); ?>" class="navigation-dot"></a>
									</li>
								</ul>
							</div>
