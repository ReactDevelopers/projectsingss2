			...
			<div class="login-inner-wrapper m-t-10px">
				<div class="row has-vr">
					<form method="POST" action="<?php echo e(url('/authenticate?back='.$back)); ?>" class="form-horizontal login-form m-auto" autocomplete="off">
						...
						<?php if(isset($talent_id)): ?>
							<input type="hidden" name="talent_id" value="<?php echo e($talent_id); ?>">
						<?php endif; ?>
						<?php if(isset($ownershiptoken)): ?>
							<input type="hidden" name="owner" value="<?php echo e($owner); ?>">
							<input type="hidden" name="ownershiptoken" value="<?php echo e($ownershiptoken); ?>">
						<?php endif; ?>
