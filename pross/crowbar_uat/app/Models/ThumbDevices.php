<?php
    ...
    class ThumbDevices extends Model{
         ...
         * @param [Integer]$device_uuid[Used for device id]
        ...
        /**
         * [This method is used for device configuration] 
         * @param [Integer]$user_id [Used for User id]
         * @param [Integer]$device_uuid[Used for device id]
        ...
        public static function remove_touch_login($device_uuid){
            return \DB::table('thumb_devices')->where('device_uuid', $device_uuid)->delete();
        }
    }