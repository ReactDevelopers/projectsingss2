...
<div class="col-md-8 col-sm-8 right-sidebar m-t-10px">
    <form role="talent_step_four" class="form-horizontal calendar-form" action="{{url(sprintf('%s/availability/save',TALENT_ROLE_TYPE))}}" method="post" accept-charset="utf-8">
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="availability-sub-details">                              
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4 hours-select">
                                            <div class="custom-dropdown">
                                                <select name="from_time_hour" class="form-control">
                                                    {!! ___dropdown_options(___range(range(01, 12)),trans('website.W0187'),'13',true) !!}
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group radio-wrapper">
                                ...
                                <div class="col-md-9">
                                    @foreach(employment_types('talent_availability_2') as $item)
