        ...
        <div class="row mainContentWrapper">
            ...
            <div class="col-md-9 job-details-left">
                <div id="parentHorizontalTab">
                    ...
                    {!! ___getmenu('talent-myjobs','<span class="toggle-menu-wrap"><buttton class="open-toggle-menu">%s</buttton><ul class="user-profile-links">%s</ul></span>','active',true,true) !!}
                    <div class="resp-tabs-container hor_1">
                        <div>
                            <div id="job_listing" class="timeline timeline-inverse"></div>
                            <div class="col-md-12">
                               <div class="col-md-12" id="loadmore">
                                    <span class="btn btn-default btn-block btn-lg hide" data-request="paginate" data-url="{{ url(sprintf('%s/my-jobs/saved?page=%s&search=%s',TALENT_ROLE_TYPE,1,Request::get('search')))}}" data-target="#job_listing" data-showing="#paginate_showing" data-loadmore="#loadmore">{{ trans('website.W0254') }}</span>
                                </div>
                            </div>   
                        </div>
                    </div>
