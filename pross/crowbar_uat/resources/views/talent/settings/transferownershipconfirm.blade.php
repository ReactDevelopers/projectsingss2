        ...
        <div >
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="talent_icon text-center">
                    <img src="{{asset('images/key-image.png')}}" />
                </div>            
                <div class="col-sm-12 text-center member_modal_text top-space">
                    <span class="hire-title">{{trans('website.W0983')}}</span>
                </div>
                <form class="form-horizontal" role="inviteMember" action="{{url(sprintf('%s/confirm-transfer-ownership/process/',TALENT_ROLE_TYPE))}}" method="POST" accept-charset="utf-8">
                <div class="form-group row text-center top-space">
                    <div class="invite-circle-radio-list col-md-12 col-sm-12">
                        <div class="invite-member-availability search-box-availability">
                            <input type="password" class="form-control" name="password" placeholder="{{trans('website.W0979')}}"  value="">
