        ...
        <div>
            <ul class="user-profile-links">
                <li class="resp-tab-item">
                    <a href="{{url('employer/find-jobs/details?job_id='.___encrypt($project->id_project))}}">
                        {{trans('website.W0678')}}
                    </a>
                </li>
                <li class="resp-tab-item">
                ...
                <li class="active">
                    <a href="{{url('employer/project/received/reviews?job_id='.___encrypt($project->id_project))}}">
                        {{trans('job.J00133')}}
                    </a>
                </li>
            </ul>
            ...
            <div class="job-detail-final">
                <div class="login-inner-wrapper" style="padding: 0 20px;">
                    <div class="review-form">
                        <h2 class="form-heading">{{trans('job.J00133')}}</h2>                            
                        <div>
