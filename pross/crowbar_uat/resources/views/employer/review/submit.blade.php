...
<div class="col-md-8 col-sm-8 right-sidebar">
    <div>
        ...
        <div class="job-detail-final">
            <form role="submit-ratings" action="{{ url(sprintf('%s/project/submit/reviews?job_id=%s',EMPLOYER_ROLE_TYPE, ___encrypt($project->id_project))) }}" method="POST" class="form-horizontal">
