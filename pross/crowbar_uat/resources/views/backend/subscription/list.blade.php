...
<section class="content">
    ...
    <input type="hidden" id="delete-subscription-url" value="{{url('administrator/subscription/delete')}}" />
</section>
@endsection
...
@push('inlinescript')
    {!! $html->scripts() !!}
    <script type="text/javascript">
    function deleteSubs(id_user){
        var url = $('#delete-subscription-url').val();
