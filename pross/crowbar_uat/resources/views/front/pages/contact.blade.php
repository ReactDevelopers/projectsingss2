                                        ...
                                        <div class="row">
                                            ...
                                            {{-- <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group has-feedback{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                                                        <label class="col-md-12 col-sm-12 col-xs-12 control-label">{{trans('website.W0053')}}</label>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                                        <div class="custom-dropdown countrycode-dropdown{{ $errors->has('country_code') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group has-feedback{{ $errors->has('message') ? ' has-error' : '' }}">
                                                    <label class="col-md-12 col-sm-12 col-xs-12 control-label">{{trans('website.W0548')}}</label>
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
