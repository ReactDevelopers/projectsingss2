...
Scooter.prototype.getAllScooterList = function(data,callback) {
    ...
    if(data.latitude !== undefined && data.longitude !== undefined) {
        sql += ' where ( 3959 * acos( cos( radians(:latitude) ) * cos( radians( latitude ) ) * cos( radians( `longitude` ) - radians(:longitude) ) + sin( radians(:latitude) ) * sin( radians( latitude ) ) ) )*1.60934 <= :range'; 
    }
