...
export default class QuestionFourth extends Component {
                        ...
                        <div className="question-one">  
                            <div className="row p-b-30">
                                <div className="col-md-6 col-sm-6 col-xs-12">
                                    <p class="c-darkGray fontbold">What is your age this year?</p>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-4 col-sm-4 col-xs-12">
                                    <NavLink to="/checkout" className="static-box sm global-shadow bg-white text-center d-block">
                                        <span className="label-text md c-darkGray">Below 35 years old</span>
                                    </NavLink>
                                </div>
                                <div className="col-md-4 col-sm-4 col-xs-12 m-t-20-xs">
                                    <NavLink to="/thirdquestion" className="static-box sm global-shadow bg-white text-center d-block">
                                        <span className="label-text md c-darkGray">35 – 39 years old</span>
                                    </NavLink>
                                </div>
                                <div className="col-md-4 col-sm-4 col-xs-12 m-t-20-xs">
                                    <NavLink to="/thirdquestion" className="static-box sm global-shadow bg-white text-center d-block">
                                        <span className="label-text md c-darkGray">40 years and above</span>
                                </NavLink>
                                </div>
                            </div>
                        </div>
