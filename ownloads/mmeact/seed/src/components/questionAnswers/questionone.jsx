...
export default class QuestionThird extends Component {
                    ...
                    <div className="question-one">  
                        <div className="row p-b-30">
                            <div className="col-md-6 col-sm-6 col-xs-12">
                                <p class="c-darkGray fontbold">What is your Nationality?</p>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-md-4 col-sm-4 col-xs-12">
                                <NavLink to="/questionsecond" className="static-box sm global-shadow bg-white text-center d-block">
                                    <span className="label-text md c-darkGray">Singapore Citizen</span>
                                </NavLink>
                            </div>
                            <div className="col-md-4 col-sm-4 col-xs-12 m-t-20-xs">
                                <NavLink to="/checkout" className="static-box sm global-shadow bg-white text-center d-block">
                                    <span className="label-text md c-darkGray">Singapore PR</span>
                                </NavLink>
                            </div>
                            <div className="col-md-4 col-sm-4 col-xs-12 m-t-20-xs">
                                <NavLink to="/checkout" className="static-box sm global-shadow bg-white text-center d-block">
                                    <span className="label-text md c-darkGray">Foreigner</span>
                                </NavLink>
                            </div>
                      </div>
                    </div>
