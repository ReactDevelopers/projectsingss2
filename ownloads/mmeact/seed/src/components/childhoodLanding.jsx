...
export default class childhoodLanding extends Component {
                    ...
                    <div className="row m-custom">
                        <div className="col-md-6 col-sm-6 col-xs-12 full-width p-custom">
                            <div className="course-wrapper-block">
                                <NavLink to="/questionLanding" className="anchor-link-black">
                                    <div className="courseheader commonspace">
                                        <h2>WSQ Adopt the Early Years Development Framework</h2>
                                    </div>
                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12 full-width p-custom">
                            <div className="course-wrapper-block">
                                <NavLink to="/questionLanding" className="anchor-link-black">
                                    <div className="courseheader commonspace">
                                        <h2>WSQ Relief Staff Programme (Early Childhood Care and Education)</h2>
                                    </div>
                                    <div className="courseimage">
                                        <img src={CourseImage}/>
                                    </div>
                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12 full-width p-custom">
                            <div className="course-wrapper-block">
                                <NavLink to="/questionLanding" className="anchor-link-black">
                                    <div className="courseheader commonspace">
                                        <h2>WSQ Advanced Certificate in Early Years</h2>
                                    </div>
                                    <div className="courseimage">
                                        <img src={CourseImage}/>
                                    </div>
                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12 full-width p-custom">
                            <div className="course-wrapper-block">
                                <NavLink to="/questionLanding" className="anchor-link-black">
                                    <div className="courseheader commonspace">
                                    <h2>WSQ Advanced Certificate in Early Childhood Care and Education</h2>
                                    </div>
                                    <div className="courseimage">
                                        <img src={CourseImage}/>
                                    </div>
